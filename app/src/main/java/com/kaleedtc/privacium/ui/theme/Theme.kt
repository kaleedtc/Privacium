package com.kaleedtc.privacium.ui.theme
...
fun SevenTheme(
    ...
    // Decide if dark theme should be used.
    val useDarkTheme = when (themeOption) {
        ThemeOption.Default -> isSystemInDarkTheme()
        ThemeOption.DARK -> true
        ThemeOption.LIGHT -> false
    }

    // If dynamic color is available (Android 12+), use it.
    // Otherwise, fall back to your static color schemes.
